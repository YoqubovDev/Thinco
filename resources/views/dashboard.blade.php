...
<head>
    ...
    <title>Thinko.uz - Admin Panel</title>
...
<div class="min-h-screen flex">
    ...
    <div class="w-64 bg-white bg-opacity-10 backdrop-blur-lg p-6">
        <div class="text-center mb-8">
            ...
            <p class="text-white opacity-80 text-sm">Admin Panel</p>
            <div class="mt-4">
                <div class="role-badge role-admin" id="currentRole">Admin</div>
            </div>
        </div>

        <nav class="space-y-2">
            <div class="nav-item active p-3 cursor-pointer text-white" onclick="showSection('dashboard')">
                <div class="flex items-center">
                    <span class="mr-3">📊</span>
                    <span>Dashboard</span>
                </div>
            </div>
            <div class="nav-item p-3 cursor-pointer text-white" onclick="showSection('users')">
                <div class="flex items-center">
                    <span class="mr-3">👥</span>
                    <span>Foydalanuvchilar</span>
                </div>
            </div>
            <div class="nav-item p-3 cursor-pointer text-white" onclick="showSection('smart-tasks')">
                <div class="flex items-center">
                    <span class="mr-3">🧠</span>
            ...
            <div class="nav-item p-3 cursor-pointer text-white" onclick="showSection('rewards')">
                <div class="flex items-center">
                    <span class="mr-3">🏆</span>
                    <span>Mukofotlar</span>
                </div>
            </div>
            <div class="nav-item p-3 cursor-pointer text-white" onclick="showSection('parental')">
                <div class="flex items-center">
                    <span class="mr-3">👨‍👩‍👧‍👦</span>
                    <span>Ota-onalar Nazorati</span>
                </div>
            </div>
            <div class="nav-item p-3 cursor-pointer text-white" onclick="showSection('analytics')">
                <div class="flex items-center">
                    <span class="mr-3">📈</span>
                    <span>Analitika</span>
                </div>
        ...
        <div class="mt-8 p-4 bg-white bg-opacity-10 rounded-lg">
            <h4 class="text-white text-sm mb-3">Role o'zgartirish (Demo)</h4>
            <select id="roleSelector" class="w-full p-2 rounded bg-white text-gray-800" onchange="switchRole()">
    ...
    <div class="flex-1 p-6 overflow-y-auto">
        ...
        <div id="dashboard" class="section">
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-white opacity-80">Tizim umumiy ko'rinishi</p>
                </div>
                    ...
                    <div class="activity-timeline">
                        <div class="activity-item">
                            <div class="bg-green-50 p-3 rounded-lg">
                                ...
                                <p class="text-sm text-gray-500">5 daqiqa oldin • +25 coin</p>
                            </div>
                        </div>
                        <div class="activity-item">
                            <div class="bg-blue-50 p-3 rounded-lg">
                                <p class="font-medium text-gray-800">Malika yangi badge oldi</p>
                                <p class="text-sm text-gray-500">12 daqiqa oldin • "Rasm Ustasi"</p>
                            </div>
                        </div>
                        <div class="activity-item">
                            <div class="bg-purple-50 p-3 rounded-lg">
                                <p class="font-medium text-gray-800">Bobur mukofot sotib oldi</p>
                                <p class="text-sm text-gray-500">1 soat oldin • Kitob (-100 coin)</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="admin-card p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center p-3 bg-yellow-50 rounded-lg">
                            <div>
                                <p class="font-medium text-yellow-800">Backup</p>
                                <p class="text-sm text-yellow-600">Oxirgi: 2 soat oldin</p>
                            </div>
        ...
        <div id="users" class="section hidden">
            <div class="flex justify-between items-center mb-6">
                ...
                <button class="bg-white text-purple-600 px-4 py-2 rounded-lg hover:bg-gray-100 transition-colors" onclick="addUser()">
            ...
            <div class="admin-card p-6 mb-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <input type="text" placeholder="Qidirish..." class="p-3 border rounded-lg" id="userSearch" onkeyup="filterUsers()">
                    <select class="p-3 border rounded-lg" id="roleFilter" onchange="filterUsers()">
                        <option value="">Barcha rollar</option>
                        <option value="admin">Admin</option>
                        <option value="parent">Ota-ona</option>
                        <option value="user">Foydalanuvchi</option>
                    </select>
                    <select class="p-3 border rounded-lg" id="statusFilter" onchange="filterUsers()">
                        <option value="">Barcha holatlar</option>
                        <option value="active">Faol</option>
                        <option value="inactive">Nofaol</option>
                        <option value="blocked">Bloklangan</option>
                    </select>
                    <button class="bg-blue-500 text-white p-3 rounded-lg hover:bg-blue-600 transition-colors" onclick="exportUsers()">
        ...
        <div id="parental" class="section hidden">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-3xl font-bold text-white">Ota-onalar Nazorati</h2>
                <button class="bg-white text-purple-600 px-4 py-2 rounded-lg hover:bg-gray-100 transition-colors" onclick="parentalSettings()">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div class="admin-card p-6">
                    <h3 class="text-xl font-bold mb-4 text-gray-800">Faol Nazorat</h3>
                    <div class="space-y-4">
                        <div class="p-4 bg-green-50 rounded-lg">
                            <div class="flex justify-between items-center">
                                <div>
                                    <h4 class="font-semibold text-green-800">Vaqt Cheklovi</h4>
                                    <p class="text-sm text-green-600">1,234 ta oila faol</p>
                                </div>
                                <div class="text-green-600">
                        ...
                        <div class="p-4 bg-blue-50 rounded-lg">
                            <div class="flex justify-between items-center">
                                <div>
                                    <h4 class="font-semibold text-blue-800">Kontent Filtri</h4>
                                    <p class="text-sm text-blue-600">987 ta oila faol</p>
                                </div>
                                <div class="text-blue-600">
                        ...
                        <div class="p-4 bg-purple-50 rounded-lg">
                            <div class="flex justify-between items-center">
                                <div>
                                    <h4 class="font-semibold text-purple-800">Faoliyat Monitoring</h4>
                                    <p class="text-sm text-purple-600">1,456 ta oila faol</p>
                                </div>
                ...
                <div class="admin-card p-6">
                    <h3 class="text-xl font-bold mb-4 text-gray-800">Ogohlantirishlar</h3>
                    <div class="space-y-3">
                        <div class="p-3 bg-yellow-50 border-l-4 border-yellow-400 rounded">
                            <p class="font-medium text-yellow-800">Vaqt chegarasi yaqinlashmoqda</p>
                            <p class="text-sm text-yellow-600">Ahmad (Oila ID: 1234) - 15 daqiqa qoldi</p>
                        </div>
                        <div class="p-3 bg-red-50 border-l-4 border-red-400 rounded">
                            <p class="font-medium text-red-800">Noto'g'ri kontent aniqlandi</p>
                            <p class="text-sm text-red-600">Malika (Oila ID: 5678) - Avtomatik bloklandi</p>
                        </div>
                        <div class="p-3 bg-blue-50 border-l-4 border-blue-400 rounded">
                            <p class="font-medium text-blue-800">Yangi faoliyat</p>
                            <p class="text-sm text-blue-600">Bobur (Oila ID: 9012) - Yangi o'yin boshladi</p>
                        </div>
                    </div>
                </div>
            </div>
...
<div id="notification" class="fixed top-4 right-4 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg transform translate-x-full transition-transform duration-300 z-50">
    <div class="flex items-center">
        ...
        <span id="notificationText">Amal bajarildi</span>
    </div>
</div>
